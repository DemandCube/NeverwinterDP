...
import com.neverwinterdp.nstorage.SegmentConsistency.Consistency;
import com.neverwinterdp.registry.RegistryException;
import com.neverwinterdp.util.text.DateUtil;
import com.neverwinterdp.util.text.TabularFormater;

abstract public class NStorageConsistencyVerifier {
  private NStorageRegistry segRegistry;
  private List<SegmentConsistency> segementConsistencies;
  private List<SegmentDescriptor>  segmentDescriptors;
  
  public NStorageConsistencyVerifier(NStorageRegistry segReg) {
    segRegistry = segReg;
  }
