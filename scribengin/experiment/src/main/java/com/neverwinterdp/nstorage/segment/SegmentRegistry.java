...
public class SegmentRegistry {
  ...
  public SegmentRegistry(Registry registry, String path) throws RegistryException {
  ...
  public SegmentDescriptor newSegment(final WriterDescriptor writer) throws RegistryException {
  ...
  public void commit(WriterDescriptor writer, SegmentDescriptor segment) throws RegistryException {
    save(writer, segment, false);
  }
  
  public void finish(WriterDescriptor writer, SegmentDescriptor segment) throws RegistryException {
    save(writer, segment, true);
  }
  
  void save(final WriterDescriptor writer, final SegmentDescriptor segment, final boolean finished) throws RegistryException {
    BatchOperations<SegmentDescriptor> op = new BatchOperations<SegmentDescriptor>() {
      @Override
      public SegmentDescriptor execute(Registry registry) throws RegistryException {
        Transaction transaction = registry.getTransaction();
  ...
  public ReaderDescriptor getReader(String name) throws RegistryException {
    return readersAllNode.getChild(name).getDataAs(ReaderDescriptor.class);
  }
  
  public ReaderDescriptor createReader(String name) throws RegistryException {
    ReaderDescriptor reader = new ReaderDescriptor(readerIdTracker.nextInt(), name) ;
    Transaction transaction = registry.getTransaction();
  ...
  public WriterDescriptor getWriter(String id) throws RegistryException {
    return writersAllNode.getChild(id).getDataAs(WriterDescriptor.class);
  }
  
  public WriterDescriptor createWriter(String name) throws RegistryException {
    WriterDescriptor writer = new WriterDescriptor(writerIdTracker.nextInt(), name) ;
    Transaction transaction = registry.getTransaction();
  ...
  public void closeWriter(WriterDescriptor writer) throws RegistryException {
    Transaction transaction = registry.getTransaction();
