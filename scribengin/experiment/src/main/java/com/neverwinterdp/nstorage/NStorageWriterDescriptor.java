...
public class NStorageWriterDescriptor {
  ...
  public NStorageWriterDescriptor() { }
  
  public NStorageWriterDescriptor(int id, String writer) {
  ...
  public void logFinishSegment() {
    if(currentSegment != null) {
      ...
      addLog("Finish writing the segment " + currentSegment + " at " + DateUtil.asCompactDateTime(finishedTime));
      currentSegment = null;
    }
  }
