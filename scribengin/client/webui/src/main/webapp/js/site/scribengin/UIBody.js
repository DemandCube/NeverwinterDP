define([
  ...
  var UIBody = Backbone.View.extend({
    ...
    onRecordThroughput: function(evt) {
      var kibanaSharedUrl = "http://188.166.155.208:5601/#/visualize/edit/Metric-Record-Throughput?embed&_g=(refreshInterval:(display:Off,pause:!f,section:0,value:0),time:(from:now-15m,mode:quick,to:now))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'name:*record')),vis:(aggs:!((id:'1',params:(field:m1Rate),schema:metric,type:sum),(id:'2',params:(customInterval:'30s',extended_bounds:(),field:timestamp,interval:custom,min_doc_count:1),schema:segment,type:date_histogram),(id:'3',params:(field:name,order:desc,orderBy:'1',size:20),schema:group,type:terms)),listeners:(),params:(addLegend:!t,addTimeMarker:!f,addTooltip:!t,defaultYExtents:!f,drawLinesBetweenPoints:!t,interpolate:linear,radiusRatio:9,scale:linear,setYExtents:!f,shareYAxis:!t,showCircles:!t,smoothLines:!t,times:!(),yAxis:()),type:line))";
    ...
    onByteThroughput: function(evt) {
      var kibanaSharedUrl = "http://188.166.155.208:5601/#/visualize/edit/Metric-Byte-Throughput?embed&_g=(refreshInterval:(display:Off,pause:!f,section:0,value:0),time:(from:now-15m,mode:quick,to:now))&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'name:*byte')),vis:(aggs:!((id:'1',params:(field:m1Rate),schema:metric,type:sum),(id:'2',params:(customInterval:'30s',extended_bounds:(),field:timestamp,interval:custom,min_doc_count:1),schema:segment,type:date_histogram),(id:'3',params:(field:name,order:desc,orderBy:'1',size:20),schema:group,type:terms)),listeners:(),params:(addLegend:!t,addTimeMarker:!f,addTooltip:!t,defaultYExtents:!f,drawLinesBetweenPoints:!t,interpolate:linear,radiusRatio:9,scale:linear,setYExtents:!f,shareYAxis:!t,showCircles:!t,smoothLines:!t,times:!(),yAxis:()),type:line))";
