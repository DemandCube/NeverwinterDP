...
$JAVACMD -Djava.ext.dirs=$APP_DIR/libs:$SCRIBENGIN_HOME/libs:$JAVA_HOME/jre/lib/ext $JAVA_OPTS $APP_OPT $LOG_OPT $MAIN_CLASS \
  ...
  --log-generator-num-of-vm 1 --log-generator-num-of-executor-per-vm 4 --log-generator-num-of-message-per-executor 500000 --log-generator-message-size 128 \
  ...
  --dataflow-wait-for-submit-timeout 150000 --dataflow-wait-for-termination-timeout 1400000 \
