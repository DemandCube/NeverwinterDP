...
public class DataflowTaskSwitchableExecutor extends DataflowTaskExecutor {
  ...
  public DataflowTaskSwitchableExecutor(DataflowTaskExecutorService service, DataflowTaskExecutorDescriptor descriptor) throws RegistryException {
